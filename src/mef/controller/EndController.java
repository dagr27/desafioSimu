...
public class EndController implements Initializable {
    ...
    @FXML private void goToInit(javafx.scene.input.MouseEvent e) throws IOException{
    ...
    @FXML private void close(javafx.scene.input.MouseEvent e) throws IOException{
        Scene scene = btnRestart.getScene();
